...
///<AutoGeneratedContent id="ObjectDataAreaMap">
	...
	OBJDATAAREA_VALUE(ADI_Module1ADSOUT, m_ADSOUT)
	OBJDATAAREA_VALUE(ADI_Module1ADSIN, m_ADSIN)
	OBJDATAAREA_VALUE(ADI_Module1variables, m_variables)
///</AutoGeneratedContent>
END_OBJDATAAREA_MAP()
...
///<AutoGeneratedContent id="MemberInitialization">
	...
	memset(&m_ADSOUT, 0, sizeof(m_ADSOUT));
	memset(&m_ADSIN, 0, sizeof(m_ADSIN));
...
void CModule1::AssignVal() {
	//Assign ADS OUT
	m_ADSOUT.Pos_L = m_Inputs.PosInc_L * INC_TO_RAD;
	m_ADSOUT.Pos_R = - m_Inputs.PosInc_R * INC_TO_RAD;
	m_ADSOUT.Vel_rads_L = m_Inputs.VelAct_L * RPM_TO_RADS;
	m_ADSOUT.Vel_rads_R = -1 * m_Inputs.VelAct_R * RPM_TO_RADS;
	/*if (m_ADSIN.Pos_reset) {
		m_ADSOUT.Pos_off_L = m_Inputs.PosInc_L * INC_TO_RAD;
		m_ADSOUT.Pos_off_R = -m_Inputs.PosInc_R * INC_TO_RAD;
	}*/
	m_ADSOUT.torque_raw = m_Inputs.torque_raw * TQ_TO_MN;

	//TODO: Calibration
	m_ADSOUT.sEMG_Ch1 = m_Inputs.sEMG_ch1 * AI_TO_V;
	m_ADSOUT.sEMG_Ch2 = m_Inputs.sEMG_ch2 * AI_TO_V;


	//Assign ADS IN

	m_Outputs.Controlword_L = m_ADSIN.Controlword_L;
	m_Outputs.Controlword_R = m_ADSIN.Controlword_R;
	m_Outputs.target_torque_L = m_ADSIN.Target_Torque_L;
	m_Outputs.target_torque_R = m_ADSIN.Target_Torque_R;
